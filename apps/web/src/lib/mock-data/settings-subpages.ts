...
const commonNoticeBullets = [
  "Mock-only until backend/auth is connected; no live workspace, team, role, provider, permission, or audit changes are written.",
...
export const settingsSubpagesMockData = {
  workspace: {
    ...
    description: "Review the static enterprise workspace profile, metadata placeholders, and official-first governance posture before any backend settings service exists.",
    headerBadges: headerBadges("Mock workspace profile"),
    heroNoteTitle: "No-live-backend workspace surface",
    heroNote: "Workspace settings are display-only. Profile, metadata, provider, and governance controls do not write to a database or connect to production services.",
    kpiCards: [
      { label: "Workspace status", value: "Ready", change: "Mock profile", description: "Static workspace profile is staged for enterprise review.", tone: "success" },
    ...
    cards: [
      { eyebrow: "Profile", title: "Company identity", description: "Workspace name, slug, legal entity, and default reporting currency are prepared as static values.", badges: [{ label: "Configured", tone: "success" }], fields: [{ label: "Currency", value: "USD" }, { label: "Legal entity", value: "Acme Holdings FZ-LLC" }] },
    ...
    tableRows: [
      ["Workspace profile", "Acme Social Intelligence", "Workspace Owner", { label: "Configured", tone: "success" }, { label: "official_safe", tone: "success" }],
  ...
  team: {
    ...
    description: "Review mock team membership, invite placeholders, role badges, account status, and access scope without connecting live authentication.",
    headerBadges: headerBadges("Mock team directory"),
    heroNoteTitle: "No-live-auth team surface",
    ...
    kpiCards: [
      { label: "Team members", value: "8", change: "4 roles", description: "Mock members show role, status, and access scope badges.", tone: "info" },
    ...
    summary: {
      ...
      title: "Invite teammates without sending email",
    ...
    cards: [
      { eyebrow: "Owner", title: "Maya Rahman", description: "Workspace Owner responsible for billing, source approvals, and enterprise settings review.", badges: [{ label: "Active", tone: "success" }, { label: "Admin", tone: "purple" }], fields: [{ label: "Access scope", value: "All workspace settings" }, { label: "Last active", value: "12 min ago" }] },
      { eyebrow: "Compliance", title: "Omar Haddad", description: "Compliance Admin reviewing provider posture, audit exports, and policy-gated capabilities.", badges: [{ label: "Active", tone: "success" }, { label: "Approval-gated", tone: "warning" }], fields: [{ label: "Access scope", value: "Policy and audit metadata" }, { label: "Last active", value: "1 hour ago" }] },
      { eyebrow: "Analytics", title: "Nora Jensen", description: "Analyst focused on connected account analytics, reports, alerts, and export review.", badges: [{ label: "Active", tone: "success" }, { label: "Read/write analytics", tone: "info" }], fields: [{ label: "Access scope", value: "Approved analytics datasets" }, { label: "Last active", value: "Today" }] },
      { eyebrow: "Executive", title: "Daniel Cho", description: "Read-only Executive seat for KPI dashboards and scheduled report visibility.", badges: [{ label: "Read-only", tone: "neutral" }, { label: "Active", tone: "success" }], fields: [{ label: "Access scope", value: "Aggregated reporting" }, { label: "Last active", value: "Yesterday" }] },
    ],
    ...
    tableRows: [
      ["Maya Rahman", { label: "Workspace Owner", tone: "purple" }, { label: "Active", tone: "success" }, "All workspace settings", { label: "Mock SSO", tone: "info" }],
      ["Omar Haddad", { label: "Compliance Admin", tone: "warning" }, { label: "Active", tone: "success" }, "Policy and audit metadata", { label: "No live auth", tone: "neutral" }],
      ["Nora Jensen", { label: "Analyst", tone: "info" }, { label: "Active", tone: "success" }, "Approved analytics datasets", { label: "Mock session", tone: "cyan" }],
      ["Pending invite", { label: "Campaign Manager", tone: "info" }, { label: "Pending", tone: "warning" }, "Connected account reporting", { label: "Email disabled", tone: "neutral" }],
    ],
  ...
  roles: {
    ...
    description: "Review mock role presets, permission scopes, governance policy badges, and no-live-permission-write boundaries for enterprise access control.",
    headerBadges: headerBadges("Mock RBAC matrix"),
    heroNoteTitle: "No-live-permission-write role surface",
    ...
    cards: [
      { eyebrow: "Admin", title: "Workspace Owner", description: "Full workspace administration, billing visibility, source approvals, and settings review.", badges: [{ label: "Approval-gated", tone: "warning" }, { label: "All settings", tone: "purple" }], bullets: ["Manage workspace metadata", "Review source preferences", "View billing and exports"] },
      { eyebrow: "Governance", title: "Compliance Admin", description: "Policy gates, provider approval review, audit exports, and retention settings oversight.", badges: [{ label: "Policy owner", tone: "success" }, { label: "Provider review", tone: "warning" }], bullets: ["Review feature classifications", "Approve licensed-provider readiness", "Export audit evidence"] },
      ...
      { eyebrow: "Campaign", title: "Campaign Manager", description: "Campaign reporting, ad intelligence, engagement trends, and owned media review.", badges: [{ label: "Connected accounts", tone: "cyan" }, { label: "Official APIs", tone: "success" }], bullets: ["View ad reporting", "Monitor campaign alerts", "Read export summaries"] },
      { eyebrow: "Executive", title: "Read-only Executive", description: "Executive dashboards, KPI snapshots, and scheduled reporting with no write access.", badges: [{ label: "Read-only", tone: "neutral" }, { label: "Aggregated data", tone: "info" }], bullets: ["View KPI cards", "Open scheduled reports", "No user or provider writes"] },
    ],
    ...
    tableRows: [
      ["Workspace settings", { label: "Workspace Owner", tone: "purple" }, "Profile, billing owner, source preferences", { label: "official_safe", tone: "success" }, { label: "No live writes", tone: "warning" }],
      ...
      ["Audit exports", { label: "Compliance Admin", tone: "warning" }, "Audit evidence and report history", { label: "official_safe_limited", tone: "info" }, { label: "No export backend", tone: "warning" }],
    ],
  ...
  auditLogs: {
    ...
    title: "Audit event review",
    description: "Review a static audit timeline and enterprise table with actor, action, source, status, confidence, freshness, and policy badges.",
    headerBadges: headerBadges("Mock audit stream"),
    heroNoteTitle: "No-live-audit-backend event surface",
    ...
    summary: {
      ...
      title: "Immutable audit trail preview",
    ...
    cards: [
      { eyebrow: "09:42 UTC", title: "Workspace profile reviewed", description: "Maya Rahman reviewed region, timezone, and owner metadata for quarterly governance readiness.", badges: [{ label: "Completed", tone: "success" }, { label: "Mock settings", tone: "info" }, { label: "official_safe", tone: "success" }], fields: [{ label: "Actor", value: "Maya Rahman" }, { label: "Confidence", value: "0.96" }, { label: "Freshness", value: "Static preview" }] },
      { eyebrow: "10:15 UTC", title: "Provider activation blocked", description: "Omar Haddad kept licensed-provider activation disabled pending legal and provenance review.", badges: [{ label: "Blocked", tone: "warning" }, { label: "Licensed provider", tone: "warning" }, { label: "Policy-gated", tone: "danger" }], fields: [{ label: "Actor", value: "Omar Haddad" }, { label: "Confidence", value: "0.94" }, { label: "Freshness", value: "Static preview" }] },
      { eyebrow: "11:03 UTC", title: "Role matrix opened", description: "Nora Jensen viewed analyst and campaign manager scopes without modifying permissions.", badges: [{ label: "Viewed", tone: "neutral" }, { label: "No write", tone: "warning" }, { label: "official_safe", tone: "success" }], fields: [{ label: "Actor", value: "Nora Jensen" }, { label: "Confidence", value: "0.89" }, { label: "Freshness", value: "Static preview" }] },
      { eyebrow: "12:28 UTC", title: "Audit export placeholder requested", description: "Compliance Admin previewed the export action, but no file or backend audit evidence was generated.", badges: [{ label: "Suppressed", tone: "neutral" }, { label: "No export backend", tone: "warning" }, { label: "official_safe_limited", tone: "info" }], fields: [{ label: "Actor", value: "Compliance Admin" }, { label: "Confidence", value: "0.91" }, { label: "Freshness", value: "Static preview" }] },
    ],
    ...
    tableRows: [
      ["09:42 UTC", "Maya Rahman", "Workspace profile reviewed", { label: "Mock settings", tone: "info" }, { label: "Completed", tone: "success" }, { label: "0.96", tone: "success" }, { label: "Static", tone: "neutral" }, { label: "official_safe", tone: "success" }],
      ["10:15 UTC", "Omar Haddad", "Provider activation blocked", { label: "Licensed provider", tone: "warning" }, { label: "Blocked", tone: "warning" }, { label: "0.94", tone: "success" }, { label: "Static", tone: "neutral" }, { label: "licensed_provider_only", tone: "warning" }],
      ["11:03 UTC", "Nora Jensen", "Role matrix opened", { label: "Mock RBAC", tone: "purple" }, { label: "Viewed", tone: "neutral" }, { label: "0.89", tone: "info" }, { label: "Static", tone: "neutral" }, { label: "official_safe", tone: "success" }],
      ["12:28 UTC", "Compliance Admin", "Audit export placeholder requested", { label: "Mock audit", tone: "cyan" }, { label: "Suppressed", tone: "neutral" }, { label: "0.91", tone: "success" }, { label: "Static", tone: "neutral" }, { label: "official_safe_limited", tone: "info" }],
    ],
    noticeTitle: "Audit logs compliance notice",
    noticeBody: "This audit logs page is static and does not read or write live audit records, generate immutable evidence, trigger export jobs, or connect to an audit backend.",
    noticeBullets: commonNoticeBullets,
  },

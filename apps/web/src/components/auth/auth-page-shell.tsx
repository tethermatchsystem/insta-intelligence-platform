...
const proofPoints = [
  "Official-source and permission-aware data paths",
  "Private beta workspaces require approval",
  "Alpha auth controls stay disabled and static",
];

const assuranceRows = [
  { label: "Authentication state", value: "Not connected" },
  { label: "Session, cookie, OAuth", value: "Not running" },
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        disabled
        aria-disabled="true"
        className="mt-2 w-full cursor-not-allowed rounded-2xl border border-slate-200 bg-slate-50/80 px-4 py-3 text-sm text-slate-500 shadow-sm outline-none placeholder:text-slate-400 disabled:border-slate-200 disabled:bg-slate-100/80 disabled:text-slate-500"
      />
...
export function AuthPageShell({
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 px-4 py-6 text-slate-950 sm:px-6 lg:px-8">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(79,70,229,0.38),_transparent_32%),radial-gradient(circle_at_82%_18%,_rgba(14,165,233,0.24),_transparent_30%),radial-gradient(circle_at_50%_100%,_rgba(16,185,129,0.14),_transparent_34%),linear-gradient(135deg,_#020617_0%,_#0f172a_48%,_#111827_100%)]" />
      ...
      <div className="pointer-events-none absolute bottom-10 right-10 h-80 w-80 rounded-full bg-cyan-400/10 blur-3xl" />
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-3rem)] max-w-7xl flex-col">
        ...
        <div className="grid flex-1 overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.07] shadow-2xl shadow-black/40 backdrop-blur xl:grid-cols-[1.02fr_0.98fr]">
          <section className="relative hidden overflow-hidden bg-slate-950 p-8 text-white xl:block">
            ...
            <div className="absolute inset-0 bg-[linear-gradient(115deg,_rgba(255,255,255,0.08),_transparent_42%),linear-gradient(180deg,_transparent,_rgba(2,6,23,0.55))]" />
            ...
            <div className="relative flex h-full min-h-[42rem] flex-col justify-between">
                ...
                <div className="mt-16 max-w-xl">
                  ...
                  <div className="mt-8 grid max-w-lg gap-3 sm:grid-cols-3">
                    <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
                      ...
                      <p className="mt-1 text-xs leading-5 text-slate-300">auth requests in Alpha</p>
                    </div>
                    <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
                      <p className="text-2xl font-semibold">0</p>
                      <p className="mt-1 text-xs leading-5 text-slate-300">provider connections started</p>
                    </div>
                    <div className="rounded-2xl border border-white/10 bg-white/10 p-4 backdrop-blur">
                      <p className="text-2xl font-semibold">100%</p>
                      <p className="mt-1 text-xs leading-5 text-slate-300">preview copy reviewable</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-4">
                ...
                <div className="grid gap-3 rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-300">Alpha boundary</p>
          ...
          <section className="bg-slate-50 p-5 sm:p-8 lg:p-10 xl:p-12">
            <div className="mx-auto flex h-full max-w-xl flex-col justify-center">
              ...
              <div className="rounded-[2rem] border border-slate-200/80 bg-white/90 p-5 shadow-2xl shadow-slate-950/10 backdrop-blur sm:p-7">
                <div className="mb-6 rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 via-white to-cyan-50 p-4 shadow-sm">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-xs leading-5 text-indigo-900/80">
                        Review the access experience safely. Alpha does not create sessions, set cookies, start OAuth, send email, connect providers, or call an auth backend.
                      </p>
                    </div>
                    <span className="w-fit rounded-full border border-indigo-200 bg-white px-3 py-1 text-xs font-semibold text-indigo-900 shadow-sm">
                      Static UI
                    </span>
                  </div>
                  <p className="mt-3 border-t border-indigo-100 pt-3 text-xs leading-5 text-slate-600">
                    Use these pages to evaluate workspace readiness, security copy, and compliance expectations before any production authentication is implemented.
                  </p>
                </div>

  ...
  return (
    <article className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm shadow-slate-200/70 transition hover:-translate-y-0.5 hover:shadow-md hover:shadow-slate-200/80">
      <div className={`flex h-48 items-end justify-between bg-gradient-to-br p-4 ${toneClasses(ad.previewTone)}`}>
        <div className="rounded-2xl bg-white/85 px-3 py-2 text-xs font-semibold text-slate-900 shadow-sm">Mock ad preview · preview-only</div>
      ...
      <div className="space-y-4 p-5">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Badge className="bg-slate-100 text-slate-700 ring-slate-200">Preview-only ad intelligence</Badge>
          </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Badge className="bg-slate-100 text-slate-700 ring-slate-200">No ad monitoring</Badge>
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/70">
      <div className="mb-4">
        ...
        <p className="mt-1 text-sm text-slate-500">Mock-only public ad library style signals; no live Ad Library ingestion, ad monitoring, scraping, private tracking, or backend action.</p>
      </div>
      ...
      <p className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm leading-6 text-amber-900">
        Competitive ad signals are mock-only and limited to preview public Ad Library style summaries or private-beta ads service placeholders. No live ad monitoring, Ad Library ingestion, backend action, scraping, private account access, hidden surveillance, or anti-bot bypass is implemented.
      </p>
    </section>
  );
}

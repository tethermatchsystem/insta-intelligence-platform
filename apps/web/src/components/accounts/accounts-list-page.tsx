    ...
    <div className="space-y-6">
      <header className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div>
            ...
            <h1 className="text-4xl font-semibold tracking-tight text-slate-950">Accounts</h1>
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          ...
          <button className="rounded-2xl border border-slate-200 bg-slate-950 px-4 py-2 text-sm font-medium text-white shadow-sm">Create account list</button>
        </div>
      ...
      <section className="rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-5 text-sm text-slate-600">
        <p className="font-semibold text-slate-900">No live integrations yet</p>
        <p className="mt-1 leading-6">

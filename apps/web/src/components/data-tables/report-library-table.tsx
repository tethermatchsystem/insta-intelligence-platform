    ...
    <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/70">
      <div className="mb-4 flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-sm text-slate-500">
            Mock report rows for executive summaries, client-ready exports, compliance review, and licensed-provider gating. Preview-only reports; no report is generated and no backend action runs from this table.
          </p>
        </div>
      ...
      <div className="overflow-x-auto rounded-2xl border border-slate-200">
        <table className="w-full min-w-[1220px] text-left text-sm">
          <caption className="sr-only">Preview-only enterprise report library with no Alpha report generation.</caption>

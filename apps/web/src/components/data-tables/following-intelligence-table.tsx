...
export function FollowingIntelligenceTable() {
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="mb-4">
        <h2 className="text-base font-semibold text-slate-950">Enterprise following table</h2>
        <p className="mt-1 text-sm text-slate-500">Category summary rows and gated identity-level placeholders prepared for compliant future providers.</p>
      </div>

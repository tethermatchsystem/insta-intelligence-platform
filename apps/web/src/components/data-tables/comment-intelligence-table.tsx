  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/70">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h2 className="text-base font-semibold text-slate-950">Enterprise comment preview table</h2>
          <p className="mt-1 text-sm text-slate-500">Mock comment rows only. No live comment monitoring, content ingestion, or backend action is running.</p>
        </div>

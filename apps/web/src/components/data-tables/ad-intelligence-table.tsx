    ...
    <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/70">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Mock ads and campaigns prepared for future Meta Marketing API connection, Meta Ad Library review, and private-beta ads service checks. No live ad monitoring is running.</p>
        </div>
